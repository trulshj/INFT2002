...
export class NewQuizQuestions extends Component<{ match: { params: { id: number } } }> {
  ...
  quizquestionoption: QuizQuestionOption = { quizQuestionOptionId: 0, quizQuestionId: 0, questionAnswer: '', isCorrect: false }
          ...
          <Column width={2}>
            ...
            <Column>
              <Form.Input
                ...
                onChange={(event) => (this.quizquestionoption.questionAnswer = event.currentTarget.value)}
              />
            <Form.Checkbox checked={this.quizquestionoption.isCorrect} onChange={() => {}} disabled /></Column>
          </Row>
          <Row>
          <Column width={2}>
