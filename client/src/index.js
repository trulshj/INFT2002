...
import { Quizzes , QuizDetail, QuizEdit, QuestionDetail } from './components/quizzes';
  ...
  ReactDOM.render(
    <HashRouter>
      <div>
        ...
        <Route exact path="/quizzes/:quizId(\d+)/:questionId(\d+)" component = {QuestionDetail}></Route>
